export default {
  ...
  themes: {
    ...
    notEnoughCoinsDesc: "Il vous manque {{need}} pièce(s). Accomplissez des quêtes pour en gagner.",
    ...
    purchaseSuccessDesc: "\"{{name}}\" a été ajouté à votre collection. Voulez-vous l'appliquer maintenant ?",
    applyNow: "Appliquer",
    ...
    sunset: { name: "Coucher de soleil", desc: "Des teintes chaudes et enflammées" },
