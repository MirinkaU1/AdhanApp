export default {
  ...
  themes: {
    ...
    notEnoughCoinsDesc: "You need {{need}} more coin(s). Complete quests to earn some.",
    confirmPurchase: "Confirm purchase",
    confirmPurchaseDesc: "Buy the \"{{name}}\" theme for {{price}} coins?",
    purchaseSuccess: "Theme unlocked! 🎨",
    purchaseSuccessDesc: "\"{{name}}\" has been added to your collection. Would you like to apply it now?",
    applyNow: "Apply",
    applyLater: "Later",
    // Theme names
